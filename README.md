...
- Augmentation: RandomScale, RandomTranslation, RandomCrop, and Color Jittering
- Kernel size of max pooling: 3

#### This Repo

- Learning rate scheduler: CosineDecay(per iteration)
- Augmentation: RandomScale, RandomTranslation, RandomCrop, Mosaic, Mixup, and Color Jittering
